...
class ProcedureResponse(models.Model):
    ...
    remarks = models.TextField(blank=True, null=True)  # Field for checker to fill remarks
    user_response = models.TextField(blank=True, null=True)  # Field for user to fill response
